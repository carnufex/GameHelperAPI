...
class TasksOrchestrator:
    ...
    # TODO: add unit tests
    def setRootTask(self, context, task: BaseTask):
    ...
    # TODO: add unit tests
    def interruptTasks(self, context, task):
    ...
    def getCurrentTaskName(self, context):
    ...
    def getNestedTask(self, task, context):
    ...
    def checkHooks(self, currentTask, context):
    ...
    # TODO: add unit tests
    def markCurrentTaskAsFinished(self, task, context, disableManualTermination=False, shouldTimeoutTreeWhenTimeout=False):
